...
objVIP = [_spawnVIP, civilian, _VIP] call BIS_fnc_spawnGroup;
...
actionID = player addAction ["Board VIP", "boardChopper.sqf", "VIP", 1.5, false, true];
...
actionID3 = pheli2 addAction["Disembark VIP", "deboardChopper.sqf", "VIP", 1.5, false, true];
